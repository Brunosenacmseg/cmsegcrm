...
export default function ImportarRCOPage() {
  ...
  async function enviar() {
    ...
    try {
      ...
      const r = await fetch('/api/importar/rco', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 28, maxWidth: 980 }}>
      <h1 style={{ fontFamily: 'DM Serif Display,serif', fontSize: 24, marginBottom: 6 }}>📥 Importação RCO</h1>
      <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 20 }}>
        Os cards serão criados no funil <strong>RCO</strong>, etapa <strong>RENOVAÇÕES À VENCER</strong>,
