...
const CAMPOS_POR_ENTIDADE: Record<Entidade, { campo: string; label: string; hints: string[]; obrigatorio?: boolean }[]> = {
  ...
  apolices: [
    // Identificação
    { campo: 'numero',           label: 'Apólice (Número)',     hints: ['apolice','apólice','policy','numero apolice','número apólice'], obrigatorio: true },
    { campo: 'tipo_documento',   label: 'Tipo Documento',        hints: ['tipo documento','tipo doc'] },
    ...
    // Cliente / vínculo
    { campo: 'cliente',          label: 'Cliente (Nome)',        hints: ['cliente','nome','segurado','razao social'] },
    { campo: 'documento_cliente',label: 'Documento do Cliente',  hints: ['documento do cliente','documento cliente','cpf','cnpj','documento'] },
    { campo: 'tipo_pessoa',      label: 'Tipo Pessoa (PF/PJ)',   hints: ['tipo pessoa','pf/pj'] },
    { campo: 'emails',           label: 'E-mails',               hints: ['email','e-mail'] },
    { campo: 'telefones',        label: 'Telefones',             hints: ['telefone','fone','celular'] },
    { campo: 'estipulante',      label: 'Estipulante',           hints: ['estipulante'] },
    // Produto / seguradora
    { campo: 'seguradora',       label: 'Seguradora',            hints: ['seguradora','cia'] },
    { campo: 'ramo',             label: 'Ramo',                  hints: ['ramo'] },
    { campo: 'produto',          label: 'Produto',               hints: ['produto'] },
    { campo: 'placa',            label: 'Placa',                 hints: ['placa'] },
    // Valores / comissão
    { campo: 'premio_liquido',   label: 'Prêmio Líquido',        hints: ['premio liquido','prêmio líquido','liquido'] },
    { campo: 'premio_total',     label: 'Prêmio Total',          hints: ['premio total','prêmio total'] },
    { campo: 'premio',           label: 'Prêmio',                hints: ['premio','prêmio','valor'] },
    { campo: 'comissao_valor',   label: 'Comissão (R$)',         hints: ['comissao','comissão'] },
    { campo: 'comissao_gerada',  label: 'Comissão Gerada',       hints: ['comissao gerada','comissão gerada'] },
    { campo: 'comissao_pct',     label: '% Comissão',            hints: ['%','pct'] },
    { campo: 'quantidade_parcelas', label: 'Quantidade Parcelas',hints: ['quantidade parcelas','parcelas','qtd parcelas'] },
    { campo: 'tipo_pagamento',   label: 'Tipo Pagamento',        hints: ['tipo pagamento','forma pagamento'] },
    { campo: 'repasse_vendedor', label: 'Repasse Vendedor',      hints: ['repasse'] },
    // Vigência / datas
    { campo: 'vigencia_ini',     label: 'Vigência Inicial',      hints: ['vigencia inicial','vigência inicial','inicio'] },
    ...
    { campo: 'data_cadastro',    label: 'Data de Cadastro',      hints: ['data de cadastro','data cadastro'] },
    { campo: 'data_controle',    label: 'Data Controle',         hints: ['data controle'] },
    // Status
    { campo: 'status_apolice',   label: 'Status Apólice',        hints: ['status apolice','status apólice','status'] },
    { campo: 'status_assinatura',label: 'Status Assinatura',     hints: ['status assinatura','assinatura'] },
    { campo: 'apolice_conferida',label: 'Apólice Conferida',     hints: ['apolice conferida','apólice conferida','conferida'] },
    ...
    // Banco / agência / conta
    { campo: 'banco',            label: 'Banco',                 hints: ['banco'] },
