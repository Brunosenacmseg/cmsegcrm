...
const CAMPOS_POR_ENTIDADE: Record<Entidade, { campo: string; label: string; hints: string[]; obrigatorio?: boolean }[]> = {
  ...
  apolices: [
    ...
    { campo: 'tipo_pessoa',        label: 'TIPO PESSOA',           hints: ['tipo pessoa','pf/pj','pf','pj'] },
    { campo: 'estipulante',        label: 'ESTIPULANTE',           hints: ['estipulante'] },
    { campo: 'emails',             label: 'EMAILS',                hints: ['emails','email','e-mail'] },
    { campo: 'telefones',          label: 'TELEFONES',             hints: ['telefones','telefone','celular','fone'] },
    // Produto
    { campo: 'ramo',               label: 'RAMO',                  hints: ['ramo'] },
    ...
    { campo: 'tipo_pagamento',     label: 'TIPO PAGAMENTO',        hints: ['tipo pagamento','pagamento'] },
      ...
      <div style={{maxWidth:980,margin:'0 auto'}}>
        ...
        {ehLiderAdm && (
          <div className="card" style={{padding:18,marginBottom:20,border:'1px solid var(--teal)'}}>
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:14,flexWrap:'wrap'}}>
              <div style={{flex:1,minWidth:240}}>
                <div style={{fontSize:14,fontWeight:600,marginBottom:6}}>📑 Importação RCO</div>
                <div style={{fontSize:12,color:'var(--text-muted)'}}>
                  Sobe uma planilha XLSX/CSV e cria negociações no funil <b>RCO</b> (etapa RENOVAÇÕES À VENCER), com <b>Bruno Sena</b> como responsável.
                </div>
              </div>
        ...
        <div style={{maxWidth:980,margin:'0 auto'}}>
          ...
          {step === 'upload' && (
            <>
              ...
              {/* Atalho: Importar Renovações (cria cards no funil RENOVAÇÕES) */}
              <div className="card" style={{padding:18,marginBottom:20,border:'1px solid var(--teal)'}}>
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:14,flexWrap:'wrap'}}>
                  <div style={{flex:1,minWidth:240}}>
                    <div style={{fontSize:14,fontWeight:600,marginBottom:6}}>🔄 Importar Renovações</div>
              ...
              {/* Atalho: Importação RCO (cria cards no funil RCO) */}
              <div className="card" style={{padding:18,marginBottom:20,border:'1px solid var(--teal)'}}>
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:14,flexWrap:'wrap'}}>
                  <div style={{flex:1,minWidth:240}}>
                    <div style={{fontSize:14,fontWeight:600,marginBottom:6}}>📑 Importação RCO</div>
