...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Importar** do CRM. Ele é voltado principalmente para a área de Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Importar dados em massa (clientes, apólices) via planilha."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Importar**.
- **Narração:** "No menu lateral, acesse **Módulo Importar**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Arquivo, Mapeamento, Resultado."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  ...
  - Validar amostra antes de importar tudo

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Importar**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
