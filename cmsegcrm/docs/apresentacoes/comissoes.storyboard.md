# Storyboard — Módulo Comissões

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Financeiro / Comercial**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Comissões** do CRM. Ele é voltado principalmente para a área de Financeiro / Comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Calcular e acompanhar as comissões devidas a cada vendedor por apólice/parcela."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Comissões**.
- **Narração:** "No menu lateral, acesse **Módulo Comissões**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Listagem de comissões por status (a pagar, paga)
  2. Demonstrativo por vendedor
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Apurar comissões do período
  2. Aprovar e liberar pagamento
  3. Exportar relatório
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Apólice, Vendedor, Percentual, Valor, Status, Data prevista."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Conferir regras de comissionamento por ramo/seguradora
  - Conciliar com Financeiro

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Comissões**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
