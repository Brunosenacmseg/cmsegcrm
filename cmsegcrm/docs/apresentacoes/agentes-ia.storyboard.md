# Storyboard — Módulo Agentes IA

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Tecnologia / Operações**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Agentes IA** do CRM. Ele é voltado principalmente para a área de Tecnologia / Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Configurar agentes de inteligência artificial para apoiar atendimento e automações."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Agentes IA**.
- **Narração:** "No menu lateral, acesse **Módulo Agentes IA**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Lista de agentes
  2. Editor de agente (prompt, conexões)
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Criar agente
  2. Definir base de conhecimento
  3. Plugar em automações
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Nome, Prompt, Modelo, Ferramentas."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Iniciar com escopo pequeno
  - Monitorar respostas semanalmente

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Agentes IA**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
