# Storyboard — Módulo Tokio Marine
...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Tokio Marine** do CRM. Ele é voltado principalmente para a área de Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Integração específica com a Tokio Marine."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Tokio Marine**.
- **Narração:** "No menu lateral, acesse **Módulo Tokio Marine**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Credenciais, Status, Última sincronização."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Conferir limite de chamadas
  - Acompanhar logs

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Tokio Marine**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
