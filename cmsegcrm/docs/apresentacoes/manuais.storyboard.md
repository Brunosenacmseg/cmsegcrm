...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Manuais** do CRM. Ele é voltado principalmente para a área de Todos."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Base de conhecimento interna com manuais e procedimentos."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Manuais**.
- **Narração:** "No menu lateral, acesse **Módulo Manuais**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Título, Categoria, Conteúdo."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Manter manuais atualizados
  - Indicar versão

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Manuais**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
