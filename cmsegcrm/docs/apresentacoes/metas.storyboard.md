...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Metas** do CRM. Ele é voltado principalmente para a área de Liderança comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Definir e acompanhar metas individuais e por equipe."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Metas**.
- **Narração:** "No menu lateral, acesse **Módulo Metas**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Painel de metas
  2. Recalcular metas (/metas/recalcular)
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Cadastrar meta
  2. Acompanhar atingimento em tempo real
  3. Recalcular após ajustes
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Período, Vendedor/Equipe, Valor da meta, Atingido."
...
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Metas**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
