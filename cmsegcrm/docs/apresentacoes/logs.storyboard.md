# Storyboard — Módulo Logs

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **TI**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Logs** do CRM. Ele é voltado principalmente para a área de TI."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Auditoria e rastreamento de eventos do sistema."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Logs**.
- **Narração:** "No menu lateral, acesse **Módulo Logs**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Listagem de logs com filtros
...
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Logs**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
