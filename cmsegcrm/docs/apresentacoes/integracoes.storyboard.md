# Storyboard — Módulo Integrações

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **TI / Operações**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Integrações** do CRM. Ele é voltado principalmente para a área de TI / Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Painel central de todas as integrações (Allianz, HDI, Meta, Sheets, Integrador)."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Integrações**.
- **Narração:** "No menu lateral, acesse **Módulo Integrações**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Parceiro, Status, Credenciais, Logs."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  ...
  - Monitorar falhas via Logs

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Integrações**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
