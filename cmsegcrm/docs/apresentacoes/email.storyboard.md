...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo E-mail** do CRM. Ele é voltado principalmente para a área de Atendimento / Comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Enviar e receber e-mails diretamente do CRM, com histórico por cliente."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo E-mail**.
- **Narração:** "No menu lateral, acesse **Módulo E-mail**. Você verá a tela inicial do módulo."
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Enviar e-mail individual ou em massa
  2. Vincular ao cliente
  3. Acompanhar abertura
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Remetente, Destinatário, Assunto, Corpo, Anexos."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Cuidar do remetente para evitar spam
  - Usar templates aprovados

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo E-mail**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
