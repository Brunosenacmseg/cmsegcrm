# Storyboard — Módulo Porto Seguro
...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Porto Seguro** do CRM. Ele é voltado principalmente para a área de Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Integração específica com a Porto Seguro para consultas e operações."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Porto Seguro**.
- **Narração:** "No menu lateral, acesse **Módulo Porto Seguro**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Painel de integração Porto
  2. Consultas/cotações
...
- **Narração:** "Atenção aos campos: Credenciais, Status da conexão, Última sincronização."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Validar credenciais periodicamente
  - Acompanhar logs de erro

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Porto Seguro**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
