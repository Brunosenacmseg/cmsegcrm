# Storyboard — Módulo Vendas do Vendedor

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Vendedor / Liderança comercial**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Vendas do Vendedor** do CRM. Ele é voltado principalmente para a área de Vendedor / Liderança comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Visão pessoal de cada vendedor sobre suas vendas, conversão e ranking."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Vendas do Vendedor**.
- **Narração:** "No menu lateral, acesse **Módulo Vendas do Vendedor**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Painel pessoal com KPIs
  2. Histórico de vendas e comissões previstas
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Acompanhar próprio funil
  2. Comparar com metas individuais
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Vendas no período, Ticket médio, Conversão, Comissão prevista."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  ...
  - Cruzar com módulo Metas

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Vendas do Vendedor**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
