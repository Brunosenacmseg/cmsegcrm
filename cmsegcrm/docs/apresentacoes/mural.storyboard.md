# Storyboard — Módulo Mural

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Comunicação interna**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Mural** do CRM. Ele é voltado principalmente para a área de Comunicação interna."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Publicar avisos, comunicados e novidades para toda a equipe."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Mural**.
- **Narração:** "No menu lateral, acesse **Módulo Mural**. Você verá a tela inicial do módulo."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Fixar comunicados críticos
  - Manter linguagem objetiva

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Mural**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
