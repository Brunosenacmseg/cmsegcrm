# Storyboard — Módulo Funis

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Liderança comercial**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Funis** do CRM. Ele é voltado principalmente para a área de Liderança comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Configurar e visualizar funis de vendas em formato kanban."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Funis**.
- **Narração:** "No menu lateral, acesse **Módulo Funis**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Visão kanban por etapa
  2. Configuração de etapas (/funis/configurar)
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  ...
  2. Mover leads entre etapas
  3. Definir regras por etapa
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Nome do funil, Etapas, Cores, Responsáveis."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Manter no máximo 6-7 etapas
  - Padronizar nomenclatura

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Funis**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
