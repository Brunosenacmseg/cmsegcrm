# Storyboard — Módulo RH

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Recursos Humanos**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo RH** do CRM. Ele é voltado principalmente para a área de Recursos Humanos."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Gerir colaboradores: cadastro, documentos e movimentações."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo RH**.
- **Narração:** "No menu lateral, acesse **Módulo RH**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Dados pessoais, Cargo, Data de admissão, Documentos."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Manter documentação digital atualizada
  - Confidencialidade dos dados

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo RH**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
