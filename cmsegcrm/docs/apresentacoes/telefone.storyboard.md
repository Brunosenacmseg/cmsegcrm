...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Telefone** do CRM. Ele é voltado principalmente para a área de Atendimento / Comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Registrar ligações realizadas/recebidas e seu desfecho."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Telefone**.
- **Narração:** "No menu lateral, acesse **Módulo Telefone**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Número, Duração, Resultado, Anotação."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Anotar sempre o resultado
  - Criar tarefa se houver retorno pendente

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Telefone**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
