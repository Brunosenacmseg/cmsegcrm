# Storyboard — Módulo Gestão de Equipe

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Liderança**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Gestão de Equipe** do CRM. Ele é voltado principalmente para a área de Liderança."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Visão consolidada da equipe: produção, atividades e performance."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Gestão de Equipe**.
- **Narração:** "No menu lateral, acesse **Módulo Gestão de Equipe**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Colaborador, Vendas, Tarefas, Atendimentos."
...
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Gestão de Equipe**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
