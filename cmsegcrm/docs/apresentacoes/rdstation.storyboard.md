# Storyboard — Módulo RD Station

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Marketing**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo RD Station** do CRM. Ele é voltado principalmente para a área de Marketing."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Integrar com RD Station para receber leads e sincronizar contatos."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo RD Station**.
- **Narração:** "No menu lateral, acesse **Módulo RD Station**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Painel de integração
  2. Mapeamento de campos (/rdstation/mapeamento)
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Mapear campos obrigatórios antes de ativar
  - Monitorar leads recebidos

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo RD Station**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
