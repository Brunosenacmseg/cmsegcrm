# Storyboard — Módulo Seguradoras

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Operações**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Seguradoras** do CRM. Ele é voltado principalmente para a área de Operações."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Cadastrar seguradoras parceiras e configurar regras (comissão, ramos)."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Seguradoras**.
- **Narração:** "No menu lateral, acesse **Módulo Seguradoras**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  1. Listagem
  2. Detalhe da seguradora (/seguradoras/[id])
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  ...
  2. Definir ramos e comissões
  3. Anexar contatos
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Nome, CNPJ, Contatos, Ramos atendidos, Tabela de comissão."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  ...
  - Revisar tabela de comissão anualmente

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Seguradoras**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
