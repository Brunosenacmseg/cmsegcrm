...
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo WhatsApp** do CRM. Ele é voltado principalmente para a área de Atendimento / Comercial."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Integrar conversas de WhatsApp ao CRM, com disparo de templates e histórico."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo WhatsApp**.
- **Narração:** "No menu lateral, acesse **Módulo WhatsApp**. Você verá a tela inicial do módulo."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Usar templates para iniciar conversa após 24h
  - Evitar mensagens em massa fora do permitido

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo WhatsApp**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
