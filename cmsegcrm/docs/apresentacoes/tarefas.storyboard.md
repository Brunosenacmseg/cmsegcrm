# Storyboard — Módulo Tarefas

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Todos os usuários**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Tarefas** do CRM. Ele é voltado principalmente para a área de Todos os usuários."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Organizar atividades individuais e da equipe vinculadas a clientes, apólices e propostas."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Tarefas**.
- **Narração:** "No menu lateral, acesse **Módulo Tarefas**. Você verá a tela inicial do módulo."
...
- **Narração:** "Atenção aos campos: Título, Descrição, Data/hora, Prioridade, Vinculação."
...
- **Narração:** "Algumas boas práticas que recomendamos:"
  - Sempre vincular à entidade origem
  - Usar prioridade alta com critério

## Cena 8 — Encerramento (5:30 – 6:00)
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Tarefas**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
