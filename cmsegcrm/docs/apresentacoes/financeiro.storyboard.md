# Storyboard — Módulo Financeiro

> Roteiro cena-a-cena para gravar o vídeo explicativo deste módulo.
> Público-alvo: **Financeiro**. Duração sugerida: **4–6 minutos**.

---

## Cena 1 — Abertura (0:00 – 0:20)
- **Tela:** card de abertura com o nome do módulo.
- **Narração:** "Olá! Neste vídeo vamos conhecer o módulo **Módulo Financeiro** do CRM. Ele é voltado principalmente para a área de Financeiro."
- **Ação:** mostrar logo/título.

## Cena 2 — Objetivo (0:20 – 0:50)
- **Tela:** slide "Objetivo".
- **Narração:** "Controlar entradas, saídas e fluxo de caixa da corretora."
- **Ação:** destacar a frase-chave em tela.

## Cena 3 — Onde encontrar (0:50 – 1:20)
- **Tela:** dashboard do CRM, clicar no menu lateral em **Módulo Financeiro**.
- **Narração:** "No menu lateral, acesse **Módulo Financeiro**. Você verá a tela inicial do módulo."
...
- **Narração:** "As principais telas são:"
  ...
  2. Listagem de lançamentos a receber/pagar
...
- **Narração:** "No dia a dia, os fluxos mais comuns são:"
  1. Registrar recebimentos
  2. Conciliar com comissões e contas a pagar
  3. Gerar relatórios
- **Ação:** executar cada fluxo na tela real.

## Cena 6 — Campos importantes (4:00 – 4:40)
- **Tela:** formulário de cadastro/edição.
- **Narração:** "Atenção aos campos: Categoria, Valor, Data, Origem, Status."
...
- **Tela:** slide final.
- **Narração:** "Esse foi o módulo **Módulo Financeiro**. Qualquer dúvida, fale com a equipe responsável. Até o próximo vídeo!"
